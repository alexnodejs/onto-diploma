...
public class Association extends AbstractModelElement{
	...
	public Association(String _model_id, String _model_name, boolean _isSpecification,
		...
		this.set_AbstractModelElement(TypeAttributesEnum.TYPE_ASSOCIATION.getTypeValue(), _model_id, _model_name, _isSpecification, _isRoot, _isLeaf, _isAbstract);
	...
	public Association(String _model_id, String _model_name,
		...
		this.set_AbstractModelElement(TypeAttributesEnum.TYPE_ASSOCIATION.getTypeValue(), _model_id, _model_name, false, false, false, false);
