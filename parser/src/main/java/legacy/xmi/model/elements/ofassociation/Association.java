...
//	}
	...
	public Association(String _model_id,
					   ...
					   MultiplicityRangeType _rangeTypeID1,
					   MultiplicityRangeType _rangeTypeID2,
					   int i) {


		this.set_AbstractModelElement(_model_id, _model_name, false, false, false, false);
		this._associationEnds.add(new AssociationEnd("_assocEndFor_"+_participantID1+i,Visibility.PUBLIC,false,true,"unordered","none","instance","changeable",_participantID1, _rangeTypeID1));
		this._associationEnds.add(new AssociationEnd("_assocEndFor_"+_participantID2+i,Visibility.PUBLIC,false,true,"unordered","none","instance","changeable",_participantID2, _rangeTypeID2));
	...
	public Association(String _model_id,
		...
		this.set_AbstractModelElement(_model_id, _model_name, false, false, false, false);
		this._associationEnds.add(new AssociationEnd("_assocEndFor_"+_participantID1+i,Visibility.PUBLIC,false,true,"unordered",_aggregationID1,"instance","changeable",_participantID1, _nameID1, _rangeTypeID1));
		this._associationEnds.add(new AssociationEnd("_assocEndFor_"+_participantID2+i,Visibility.PUBLIC,false,true,"unordered",_aggregationID2,"instance","changeable",_participantID2, _nameID2, _rangeTypeID2));
